...
func (ra *redisAdapter) Init(conf *Config) error {
...
func (ra *redisAdapter) Get(key string, serialize bool, compress bool) (item *Item, err error) {
...
func (ra *redisAdapter) Set(item Item, serialize bool, compress bool) error {
...
func (ra *redisAdapter) SetWithTimeout(item Item, serialize bool, compress bool, ttl int32) error {
	hashKey := ra.getHashKey(item.Key)
...
func (ra *redisAdapter) DeleteBatch(keys []string) error {
	hashCountTemp := 0
...
func (ra *redisAdapter) GetBatch(keys []string, serialize bool, compress bool) (items map[string]*Item, err error) {
