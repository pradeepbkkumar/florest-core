...
func (d *DataDogAgentClient) Init(conf *MonitorConf) (err error) {
...
func (d *DataDogAgentClient) Info(data *MonitorData) (err error) {
	defer recoverFromPanic(&err)
...
func (d *DataDogAgentClient) Success(data *MonitorData) (err error) {
	defer recoverFromPanic(&err)
...
func (d *DataDogAgentClient) Warning(data *MonitorData) (err error) {
	defer recoverFromPanic(&err)
...
func (d *DataDogAgentClient) Error(data *MonitorData) (err error) {
	defer recoverFromPanic(&err)
...
func newDogstatsdAgent(conf *MonitorConf) (d *DataDogAgentClient, err error) {
	defer recoverFromPanic(&err)
